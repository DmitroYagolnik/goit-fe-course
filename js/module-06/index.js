...
class Hamburger {
  ...
  calculatePrice() {
    ...
    const staffingsPrice = Hamburger.STUFFINGS[this._stuffing].price;
    const topingsPrice = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc, 0);
    return sizePrice + staffingsPrice + topingsPrice;
  }
  ...
  calculateCalories() {
    ...
    const staffingsCalories = Hamburger.STUFFINGS[this._stuffing].calories;
    const topingsCalories = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].calories + acc, 0);
    return sizeCalories + staffingsCalories + topingsCalories;
  }
}
